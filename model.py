...
#
#         self.weight = nn.Parameter(torch.FloatTensor(out_ch, in_ch, kernel_size, kernel_size))
...
#     Z_DIM = 512
#     IN_CHANNEL = 512
#     gen = Generator(Z_DIM, IN_CHANNEL, img_channels=3)
#     critic = Discriminator(IN_CHANNEL, img_channels=3)
